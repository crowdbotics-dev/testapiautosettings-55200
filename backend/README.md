...
## Project Structure
    ...
    ├── testapiautosettings_55200  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_55200`
...
2. Clone this repo and `cd testapiautosettings_55200`
